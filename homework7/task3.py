...
class PublicTransport:
    ...
    def info(self):
        """
        Возвращает информацию о ТС: Марку, цвет, год выпуска и мощность двигателя
        :return: марка, цвет, год выпуска и мощность двигателя
        """
...
class Bus(PublicTransport):
    ...
    def park(self):
        """
        Возвращает номер парка ТС
        :return: номер парка ТС
        """
        return self.__park
    ...
    def park(self, num):
        """
        Меняет номер парка ТС если он соответствует требованиям: 1000 < введенный номер < 9999
        :param num: введенный номер
        """
        if 1000 <= num <= 9999:
            self.__park = num
        assert self.__park == num, 'Несуществующий номер парка'
...
class Tram(PublicTransport):
    ...
    def how_long(self):
        """
        Возвращает длительность прохождения маршрута трамваем
        :return: длительность прохождения маршрута
        """
