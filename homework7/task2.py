...
class PersonInfo:
    ...
    def short_name(self):
        """
        Приводит Фамилию и Имя сотрудника к формату: Фамилия И.
        :return: Фамилия И.
        """
    ...
    def path_deps(self):
        """
        Возвращает путь вложенности подразделения сотрудника в формате: Головное --> ... --> Конечное
    ...
    def new_salary(self):
        """
        Возвращает сумму зарплаты сотрудника выведенную по формулеЖ
        1337 * возраст * сумма первых трех максимальных вхождений символов в полном пути подразделения
