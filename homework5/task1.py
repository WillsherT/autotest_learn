...
def letter_stat(our_str: str) -> dict:
    """
    Возвращает словарь, где в качестве ключей: буквы из принимаемой строки,
    а значения: количество вхождений данной буквы в строку
    :param our_str: Принимаемая строка.
    :return letters_dict: Возвращаем полученный словарь.
    """
