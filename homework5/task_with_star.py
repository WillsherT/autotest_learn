...
def to_roman(val):
    ...
    :dict_of_roman: Словарь, где ключ: римская буква, а значение: арабская цифра.
    :return roman_str: Возвращаем строку, содержащую полученное число в виде римского
    """
    dict_of_roman = {'M': 1000, 'CM': 900, 'D': 500, 'CD': 400,
                     'C': 100, 'XC': 90, 'L': 50, 'XL': 40,
                     'X': 10, 'IX': 9, 'V': 5, 'IV': 4, 'I': 1}
    roman_str = ''
    for roman, arab in dict_of_roman.items():
        while val >= arab:
            roman_str += roman
            val -= arab
