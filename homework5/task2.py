...
def repeats(our_str):
    ...
    :param our_str: полученная строка
    :return new_str: возвращаемая строка
    """
    new_str = ''.join(char + '_' + str(our_str[:index + 1].count(char)) for index, char in enumerate(our_str))
